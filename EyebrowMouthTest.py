...
while True:
    ...
    for face in faces:
        ...
        eye = masked_eye[min_y_left: max_y_left, min_x_left: max_x_left]
        eye = masked_eye[min_y_right: max_y_right, min_x_right: max_x_right]
        ...
        circles = cv2.HoughCircles(edges, cv2.HOUGH_GRADIENT, 1, 10000, param1=50, param2=30, minRadius=0,
                                   maxRadius=0)

        T2, B2 = cv2.threshold(gray_eye, 0, maxval=255, type=cv2.THRESH_BINARY)
        ...
        # splitting the left eye in left and right sides
        ...
        # splitting the right eye in left and right sides
        ...
        # counting the amount of black (pupil) that appears in each side of each eye
